...
public class ProductController {
    ...
    public ResponseEntity getCityEqualDistribution(@RequestParam String cep, @RequestParam String id){
        boolean cityEqualDistribution = addressSearch.cityEqualDistribution(cep, id);
        if (cityEqualDistribution == false){
            return ResponseEntity.ok().body("A distribuidora e a cidade do usuário não são as mesmas");
        }
        return ResponseEntity.ok().body("A distribuidora e a cidade do usuário são as mesmas");
    }
